<template>
   <div>
                ...
                <div class="lg:m-0 -mx-5 flex justify-between items-center py-2 relative space-x-3 dark-tabs uk-sticky" uk-sticky="cls-active: bg-gray-100 bg-opacity-95; media : @m ; media @m" style="">
                ...
                </div><div class="uk-sticky-placeholder" style="height: 71px; margin: 0px;" hidden=""></div>
